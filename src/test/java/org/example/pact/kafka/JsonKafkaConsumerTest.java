package org.example.pact.kafka;
...
class JsonKafkaConsumerTest {
	...
	private Deserializer<ConsumerDomainRecord> getProductionKafkaDeserializer() {
		KafkaJsonDeserializer<ConsumerDomainRecord> domainRecordKafkaJsonDeserializer = new KafkaJsonDeserializer<ConsumerDomainRecord>();
